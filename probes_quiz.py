...
def probes_quiz(clear_main_content, create_card2, main_window):
    ...
    title_label = tk.Label(quiz_frame, text="Multiple choice questions", font=(font_family, 32), fg="white", bg="black")
